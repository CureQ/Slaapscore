# Bestandsnaam: Prepare_ECG_files_android_gui.py
# Geschreven door: Esmee Springer
# Laatst bewerkt op: 23-05-2025
...
def get_hdf5_file_android(ecg_file, file_counter, show_plots=False):
    ...
    if show_plots:
        plt.close()
        # Plot de ECG waarden van de ruwe data
    ...
    filtered_ecg = notch_filter(filtered_ecg, freq=60, fs=hertz)  
    filtered_ecg
    ...
    # Bereken de tijdsverschillen tussen de opeenvolgende pieken (RR-intervals) in seconden
    ...
    spike_value_df = df.iloc[peaks]  # Gebruik de indexen van de pieken om de relevante rijen te selecteren
    ...
    # inzoomen voor een duidelijke weergave van het ECG-signaal
    ...
    # Bepaal de map waarin de originele ECG-file zich bevindt
